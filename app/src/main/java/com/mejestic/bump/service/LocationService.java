...
public class LocationService extends Service
  ...
  private static final String TAG = LOG_TAG + LocationService.class.getSimpleName();
      ...
      if ((curTime - lastUpdate) > 1000) {
        ...
        if (speed > SHAKE_THRESHOLD && sp > 1) {
          ...
          if (mCurrentLocation != null) {
            ...
            dbHelper.insertData(mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude(),
